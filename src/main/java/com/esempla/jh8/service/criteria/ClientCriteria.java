...
/**
 * Criteria class for the {@link com.esempla.jh8.domain.Client} entity. This class is used
 * in {@link com.esempla.jh8.web.rest.ClientResource} to receive all the possible filtering options from
...
public class ClientCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, firstName, lastName, email, telephone, distinct);
    }
